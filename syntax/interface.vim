...
syntax match wirelessKeyword  '\vwpa-psk|wpa-conf|wpa-driver|wpa-channel|wpa-key-mgmt|wpa-mode|wireless-key|wireless-essid|wireless-channel|wireless-mode|wpa-ssid' contained
...
exe 'syntax match wpa_mode /' .  '\v^\s*(wpa-mode)\s+' . wpamode  . '\s*$' . '/ contains=wirelessKeyword'
